...
namespace PS2_API_MstProduct.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int orderId)
        {
            ...
            return Json(new { status = "200", message = "Success", data = OrderVM });
        }
        ...
        public IActionResult UpdateOrderDetails(int orderId)
        {
            ...
            return Json(new { status = "200", message = "Success", data = new { orderId = orderHeaderFromDb.Id} });
        }
        ...
        public IActionResult StartProcessing()
        {
            ...
            return Json(new { status = "200", message = "Success", data = new { orderId = OrderVM.OrderHeader.Id } });
        }
